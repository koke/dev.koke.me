const socialIcons = {
  ...
  >
    <path
      d="m31.1 32.2.2-.3-2.4-6.8c0-.1-.1-.1-.1-.1h-4.6c-.1 0-.2.1-.2 0-.1-.2 0-.6 0-.9v-7.1h6v-10h-6v-7h-11c-.7 0-1.6.8-1.7 1.8-.5 4.1-2.2 5.7-5.8 6.9l-.4.1c-.1.1-.1.1-.1.2v8c0 .1.1 0 .1 0h3.9v7.8c0 7 4.5 11.2 13.4 11.2 4.7 0 7.6-2.3 8.7-3.8zm-7.6 1.4h-.2c-7.2 0-9.3-5.4-9.3-8.6v-10h-4v-5c0-.1.1-.1.2-.1 3.7-1.4 6.1-3.2 6.7-7.6-.1-.3.1-.3.1-.3h4.8.2v7h6v6h-6v9.1c0 2.1.8 3.2 2.8 3.2.8 0 1.7-.2 2.6-.5.1 0 .2 0 .2.1l1.5 4.4v.4c-1.1 1.1-3.4 1.9-5.6 1.9z"
      fill-rule="evenodd"
    />
  </svg>`,
};
